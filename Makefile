...
update_2016: 
	...
	@sed -i 's|TCut mycuts = [A-z]\++[A-z]\+;|Tcut mycuts = clearnNAN_tau;|g' vbsTMVAClassification.C
...
update_0000:
	...
	@sed -i 's|TCut mycuts = [A-z]\+;|Tcut mycuts = clearnNAN+cleanNAN_phi;|g' vbsTMVAClassification.C
