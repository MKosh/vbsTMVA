...
\begin{document}
    ...
    \section*{2018}
      ...
      \subsection*{Wjets\_CR}
                        ...
                        \end{figure}    
      \subsection*{Top\_Test\_CR}
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c1 variables using cut: ``Top\_Test\_CR"}
                            \includegraphics[width=\textwidth]{2018/c1_2018_Top_Test_CR.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c2 variables using cut: ``Top\_Test\_CR"}
                            \includegraphics[width=\textwidth]{2018/c2_2018_Top_Test_CR.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c3 variables using cut: ``Top\_Test\_CR"}
                            \includegraphics[width=\textwidth]{2018/c3_2018_Top_Test_CR.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c4 variables using cut: ``Top\_Test\_CR"}
                            \includegraphics[width=\textwidth]{2018/c4_2018_Top_Test_CR.pdf}
                        \end{figure}    
      \subsection*{WV\_SR\_HinPV}
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c1 variables using cut: ``WV\_SR\_HinPV"}
                            \includegraphics[width=\textwidth]{2018/c1_2018_WV_SR_HinPV.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c2 variables using cut: ``WV\_SR\_HinPV"}
                            \includegraphics[width=\textwidth]{2018/c2_2018_WV_SR_HinPV.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c3 variables using cut: ``WV\_SR\_HinPV"}
                            \includegraphics[width=\textwidth]{2018/c3_2018_WV_SR_HinPV.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c4 variables using cut: ``WV\_SR\_HinPV"}
                            \includegraphics[width=\textwidth]{2018/c4_2018_WV_SR_HinPV.pdf}
                        \end{figure}    
      \subsection*{WV\_SR\_Test}
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c1 variables using cut: ``WV\_SR\_Test"}
                            \includegraphics[width=\textwidth]{2018/c1_2018_WV_SR_Test.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c2 variables using cut: ``WV\_SR\_Test"}
                            \includegraphics[width=\textwidth]{2018/c2_2018_WV_SR_Test.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c3 variables using cut: ``WV\_SR\_Test"}
                            \includegraphics[width=\textwidth]{2018/c3_2018_WV_SR_Test.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c4 variables using cut: ``WV\_SR\_Test"}
                            \includegraphics[width=\textwidth]{2018/c4_2018_WV_SR_Test.pdf}
                        \end{figure}    
      \subsection*{Wjets\_Elec\_CR}
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c1 variables using cut: ``Wjets\_Elec\_CR"}
                            \includegraphics[width=\textwidth]{2018/c1_2018_Wjets_Elec_CR.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c2 variables using cut: ``Wjets\_Elec\_CR"}
                            \includegraphics[width=\textwidth]{2018/c2_2018_Wjets_Elec_CR.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c3 variables using cut: ``Wjets\_Elec\_CR"}
                            \includegraphics[width=\textwidth]{2018/c3_2018_Wjets_Elec_CR.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c4 variables using cut: ``Wjets\_Elec\_CR"}
                            \includegraphics[width=\textwidth]{2018/c4_2018_Wjets_Elec_CR.pdf}
                        \end{figure}    
      \subsection*{Wjets\_Muon\_CR}
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c1 variables using cut: ``Wjets\_Muon\_CR"}
                            \includegraphics[width=\textwidth]{2018/c1_2018_Wjets_Muon_CR.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c2 variables using cut: ``Wjets\_Muon\_CR"}
                            \includegraphics[width=\textwidth]{2018/c2_2018_Wjets_Muon_CR.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c3 variables using cut: ``Wjets\_Muon\_CR"}
                            \includegraphics[width=\textwidth]{2018/c3_2018_Wjets_Muon_CR.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c4 variables using cut: ``Wjets\_Muon\_CR"}
                            \includegraphics[width=\textwidth]{2018/c4_2018_Wjets_Muon_CR.pdf}
                        \end{figure}    
      \subsection*{Wjets\_Test\_CR}
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c1 variables using cut: ``Wjets\_Test\_CR"}
                            \includegraphics[width=\textwidth]{2018/c1_2018_Wjets_Test_CR.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c2 variables using cut: ``Wjets\_Test\_CR"}
                            \includegraphics[width=\textwidth]{2018/c2_2018_Wjets_Test_CR.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c3 variables using cut: ``Wjets\_Test\_CR"}
                            \includegraphics[width=\textwidth]{2018/c3_2018_Wjets_Test_CR.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c4 variables using cut: ``Wjets\_Test\_CR"}
                            \includegraphics[width=\textwidth]{2018/c4_2018_Wjets_Test_CR.pdf}
                        \end{figure}    
\end{document}
