    ...
    \section*{2018}
      ...
      \subsection*{Wjets\_CRscale}
                        \begin{figure}[H]
                            ...
                            \includegraphics[width=\textwidth]{2018/c1_2018_Wjets_CRscale.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c2 variables using cut: ``Wjets\_CRscale"}
                            \includegraphics[width=\textwidth]{2018/c2_2018_Wjets_CRscale.pdf}
                        \end{figure}    
                        \begin{figure}[H]
                            \centering
                            \caption{2018 plot of c3 variables using cut: ``Wjets\_CRscale"}
                            \includegraphics[width=\textwidth]{2018/c3_2018_Wjets_CRscale.pdf}
                        \end{figure}    
\end{document}
