...
make mon loc="" year="1111" saveFile="Run2_wv_boosted" lumi="59.74" cut="full_wv_sr+tau21_cut+qgid_cut" mon_function="optCutScan" plot_type=r var_to_plot="BDT" plot_name="Run2_wv_boosted_optCut_BDT" | tee -a docs/logs/Run2_wv_boosted.log
make mon loc="" year="1111" saveFile="Run2_wv_boosted" lumi="59.74" cut="full_wv_sr+tau21_cut+qgid_cut" mon_function="optCutScan" plot_type=r var_to_plot="DNN_GPU" plot_name="Run2_wv_boosted_optCut_DNN" | tee -a docs/logs/Run2_wv_boosted.log
...
make mon loc="" year="1111" saveFile="Run2_wv_SR" lumi="59.74" cut="full_wv_sr+tau21_cut+qgid_cut" mon_function="optCutScan" plot_type=r var_to_plot="BDT" plot_name="Run2_wv_SR_optCut_BDT_BDT" | tee -a docs/logs/Run2_wv_SR.log
make mon loc="" year="1111" saveFile="Run2_wv_SR" lumi="59.74" cut="full_wv_sr+tau21_cut+qgid_cut" mon_function="optCutScan" plot_type=r var_to_plot="DNN_GPU" plot_name="Run2_wv_SR_optCut_DNN_DNN" | tee -a docs/logs/Run2_wv_SR.log
