...
#Run2 training
make train loc="" year="1111" vars="boosted3" methods="BDT,DNN_GPU" saveFile="Run2_wv_boosted_year" dataset="dataset.xml" training_cut=wv_boosted | tee docs/logs/Run2_wv_boosted_year.log
make train loc="" year="1111" vars="boosted3" methods="BDT,DNN_GPU" saveFile="Run2_wv_SR_year" dataset="dataset.xml" training_cut=full_wv_sr | tee docs/logs/Run2_wv_SR_year.log

#Run2 wv_boosted optCutScan, cutflow, and control plots
make mon loc="" year="1111" saveFile="Run2_wv_boosted_year" lumi="137" cut="full_wv_sr+tau21_cut+qgid_cut" mon_function="optCutScan" plot_type=r var_to_plot="BDT" plot_name="Run2_wv_boosted_optCut_BDT" | tee -a docs/logs/Run2_wv_boosted_year.log
make mon loc="" year="1111" saveFile="Run2_wv_boosted_year" lumi="137" cut="full_wv_sr+tau21_cut+qgid_cut" mon_function="optCutScan" plot_type=r var_to_plot="DNN_GPU" plot_name="Run2_wv_boosted_optCut_DNN" | tee -a docs/logs/Run2_wv_boosted_year.log
make mon loc="" year="1111" saveFile="Run2_wv_boosted_year" lumi="137" cut="full_wv_sr+tau21_cut+qgid_cut" mon_function="cplots" plot_type=r plot_name="Run2_wv_boosted" | tee -a docs/logs/Run2_wv_boosted_year.log

#Run2 wv_SR optCutScan, cutflow, and control plots
make mon loc="" year="1111" saveFile="Run2_wv_SR_year" lumi="137" cut="full_wv_sr+tau21_cut+qgid_cut" mon_function="optCutScan" plot_type=r var_to_plot="BDT" plot_name="Run2_wv_SR_optCut_BDT_BDT" | tee -a docs/logs/Run2_wv_SR_year.log
make mon loc="" year="1111" saveFile="Run2_wv_SR_year" lumi="137" cut="full_wv_sr+tau21_cut+qgid_cut" mon_function="optCutScan" plot_type=r var_to_plot="DNN_GPU" plot_name="Run2_wv_SR_optCut_DNN_DNN" | tee -a docs/logs/Run2_wv_SR_year.log
make mon loc="" year="1111" saveFile="Run2_wv_SR_year" lumi="137" cut="full_wv_sr+tau21_cut+qgid_cut" mon_function="cplots" plot_type=r plot_name="Run2_wv_SR" | tee -a docs/logs/Run2_wv_SR_year.log
