...
make mon loc="" year="2016" saveFile="2016_wv_SR" lumi="35.87" cut="full_wv_sr+tau21_cut+qgid_cut+BDT_cut_2016_sr" mon_function="genPlots" plot_type=r plot_name="wv_SR_BDT_plots" | tee -a docs/logs/2016_wv_SR.log
make mon loc="" year="2016" saveFile="2016_wv_SR" lumi="35.87" cut="full_wv_sr+tau21_cut+qgid_cut+DNN_GPU_cut_2016_sr" mon_function="genPlots" plot_type=r plot_name="wv_SR_DNN_plots" | tee -a docs/logs/2016_wv_SR.log
# 2017
...
make mon loc="" year="2017" saveFile="2017_wv_SR" lumi="41.53" cut="full_wv_sr+tau21_cut+qgid_cut+BDT_cut_2017_sr" mon_function="genPlots" plot_type=r plot_name="wv_SR_BDT_plots" | tee -a docs/logs/2017_wv_SR.log
make mon loc="" year="2017" saveFile="2017_wv_SR" lumi="41.53" cut="full_wv_sr+tau21_cut+qgid_cut+DNN_GPU_cut_2017_sr" mon_function="genPlots" plot_type=r plot_name="wv_SR_DNN_plots" | tee -a docs/logs/2017_wv_SR.log
# 2018
...
make mon loc="" year="2018" saveFile="2018_wv_SR" lumi="59.74" cut="full_wv_sr+tau21_cut+qgid_cut+BDT_cut_2018_sr" mon_function="genPlots" plot_type=r plot_name="wv_SR_BDT_plots" | tee -a docs/logs/2018_wv_SR.log
make mon loc="" year="2018" saveFile="2018_wv_SR" lumi="59.74" cut="full_wv_sr+tau21_cut+qgid_cut+DNN_GPU_cut_2018_sr" mon_function="genPlots" plot_type=r plot_name="wv_SR_DNN_plots" | tee -a docs/logs/2018_wv_SR.log
# Run2 Full
...
make mon loc="" year="1111" saveFile="Run2_wv_SR" lumi="137" cut="full_wv_sr+tau21_cut+qgid_cut+BDT_cut_Run2_sr" mon_function="genPlots" plot_type=r plot_name="wv_SR_BDT_plots" | tee -a docs/logs/Run2_wv_SR.log
make mon loc="" year="1111" saveFile="Run2_wv_SR" lumi="137" cut="full_wv_sr+tau21_cut+qgid_cut+DNN_GPU_cut_Run2_sr" mon_function="genPlots" plot_type=r plot_name="wv_SR_DNN_plots" | tee -a docs/logs/Run2_wv_SR.log
# Run2 Combined
...
#make mon loc="" year="1111" saveFile="Run2_Summed" lumi="137" cut="full_wv_sr+tau21_cut+qgid_cut+DNN_cut_Run2_Summed" mon_function="cplots" plot_type=r plot_name="Summed_DNN" | tee -a docs/logs/Run2_Summed.log
