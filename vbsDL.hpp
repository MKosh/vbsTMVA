...
#define vbsDL_hpp
//
//Note::Autogenerated with writeDL.sh on Mon Mar 28 07:11:11 PM EDT 2022
//Please check vbsDL*.hpp for available configurations.
//TMVA vars:
//yearf bos_PuppiAK8_eta bos_PuppiAK8_tau2tau1 vbf_m lep1_eta nJet30f vbf_deta vbf1_AK4_pt zeppLep vbf2_AK4_qgid vbf1_AK4_qgid vbf2_AK4_eta vbf1_AK4_eta vbf2_AK4_pt zeppHad vbf_eta bos_PuppiAK8_m_sd0_corr dibos_m
...
//TMVA variable
if(dataloader) dataloader->AddVariable("yearf", "yearf", "", 'F');
if(datareader) datareader->AddVariable("yearf",    &vbsEvent.yearf        );
