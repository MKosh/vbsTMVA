...
#define vbsDL_hpp
//
//Note::Autogenerated with writeDL.sh on Mon Sep  6 06:51:51 PM EDT 2021
//Please check vbsDL*.hpp for available configurations.
//TMVA vars:
//vbf2_AK4_pt vbf1_AK4_pt zeppLep vbf_m lep1_eta lep1_pt vbf_pt vbf2_AK4_eta dibos_pt dibos_m dilep_eta dilep_m bos_PuppiAK8_tau2tau1 vbf_deta bos_PuppiAK8_m_sd0_corr bos_PuppiAK8_pt bos_AK4AK4_m
...
//TMVA variable
if(dataloader) dataloader->AddVariable("dilep_eta", "dilep_eta", "", 'F');
if(datareader) datareader->AddVariable("dilep_eta",    &vbsEvent.dilep_eta        );
 
//TMVA variable
if(dataloader) dataloader->AddVariable("dilep_m", "dilep_m", "", 'F');
if(datareader) datareader->AddVariable("dilep_m",    &vbsEvent.dilep_m        );
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("zeppHad",    "zeppHad",   "",      'F');
if(datareader) datareader->AddSpectator("zeppHad",    &vbsEvent.zeppHad        );
