...
#define vbsDL_hpp
//
//Note::Autogenerated with writeDL.sh on Wed Apr 14 09:17:32 CDT 2021
//Please check vbsDL*.hpp for available configurations.
//TMVA vars:
//lep1_pt lep1_eta MET vbf_m vbf_pt vbf_deta vbf_eta vbf_phi bos_PuppiAK8_pt bos_PuppiAK8_eta bos_PuppiAK8_tau2tau1 bos_PuppiAK8_m_sd0_corr dibos_m dibos_eta dibos_mt dibos_phi dibos_pt vbf2_AK4_eta vbf1_AK4_eta vbf1_AK4_pt vbf2_AK4_pt bosCent zeppLep zeppHad
...
//TMVA variable
if(dataloader) dataloader->AddVariable("dibos_eta", "dibos_eta", "", 'F');
if(datareader) datareader->AddVariable("dibos_eta",    &vbsEvent.dibos_eta        );
...
//TMVA variable
if(dataloader) dataloader->AddVariable("dibos_mt", "dibos_mt", "", 'F');
if(datareader) datareader->AddVariable("dibos_mt",    &vbsEvent.dibos_mt        );
 
//TMVA variable
if(dataloader) dataloader->AddVariable("dibos_phi", "dibos_phi", "", 'F');
if(datareader) datareader->AddVariable("dibos_phi",    &vbsEvent.dibos_phi        );
...
//TMVA variable
if(dataloader) dataloader->AddVariable("vbf_phi", "vbf_phi", "", 'F');
if(datareader) datareader->AddVariable("vbf_phi",    &vbsEvent.vbf_phi        );
