...
#define vbsDL_hpp
//
//Note::Autogenerated with writeDL.sh on Mon Jul 26 10:52:52 AM EDT 2021
//Please check vbsDL*.hpp for available configurations.
//TMVA vars:
//lep1_eta lep1_pt nJet30 vbf1_AK4_pt vbf2_AK4_pt bos_j1_AK4_pt bos_j2_AK4_pt vbf_m bos_AK4AK4_m vbf_deta vbf_eta bos_AK4AK4_eta zeppHad zeppLep bosCent
...
//TMVA variable
if(dataloader) dataloader->AddVariable("nJet30", "nJet30", "", 'F');
if(datareader) datareader->AddVariable("nJet30",    &vbsEvent.nJet30        );
