...
#define vbsDL_hpp
//
//Note::Autogenerated with writeDL.sh on Fri Oct  8 11:09:51 AM EDT 2021
//Please check vbsDL*.hpp for available configurations.
//TMVA vars:
//vbf2_AK4_pt vbf1_AK4_pt zeppLep zeppHad nJet30f vbf_m lep1_eta lep1_pt vbf1_AK4_eta vbf2_AK4_eta dibos_pt dibos_m dibos_eta dilep_pt dilep_eta dilep_m bos_PuppiAK8_tau2tau1 vbf_deta vbf_eta bos_PuppiAK8_m_sd0_corr bos_PuppiAK8_pt bosCent vbf1_AK4_qgid vbf2_AK4_qgid MET MET_phi
...
//TMVA variable
if(dataloader) dataloader->AddVariable("dilep_pt", "dilep_pt", "", 'F');
if(datareader) datareader->AddVariable("dilep_pt",    &vbsEvent.dilep_pt        );
...
//TMVA variable
if(dataloader) dataloader->AddVariable("MET_phi", "MET_phi", "", 'F');
