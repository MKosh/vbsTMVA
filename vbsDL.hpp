...
#define vbsDL_hpp
//
//Note::Autogenerated with writeDL.sh on Mon Mar 15 17:46:04 CDT 2021
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("vbf_m",    "vbf_m",   "",      'F');
if(datareader) datareader->AddSpectator("vbf_m",    &vbsEvent.vbf_m        );
