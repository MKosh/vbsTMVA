...
#define vbsDL_hpp
//
//Note::Autogenerated with writeDL.sh on Mon Feb 21 09:15:54 PM EST 2022
//Please check vbsDL*.hpp for available configurations.
//TMVA vars:
//vbf_m nJet30f zeppLep vbf2_AK4_eta zeppHad bos_PuppiAK8_m_sd0_corr
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("AntiIsoInt",    "AntiIsoInt",   "",      'I');
if(datareader) datareader->AddSpectator("AntiIsoInt",    &vbsEvent.AntiIsoInt        );
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("lep1_eta",    "lep1_eta",   "",      'F');
if(datareader) datareader->AddSpectator("lep1_eta",    &vbsEvent.lep1_eta        );
 
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("lep1_idEffWeight",    "lep1_idEffWeight",   "",      'F');
if(datareader) datareader->AddSpectator("lep1_idEffWeight",    &vbsEvent.lep1_idEffWeight        );
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("lep1_trigEffWeight",    "lep1_trigEffWeight",   "",      'F');
if(datareader) datareader->AddSpectator("lep1_trigEffWeight",    &vbsEvent.lep1_trigEffWeight        );
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("lep2_idEffWeight",    "lep2_idEffWeight",   "",      'F');
if(datareader) datareader->AddSpectator("lep2_idEffWeight",    &vbsEvent.lep2_idEffWeight        );
 
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("lep2_phi",    "lep2_phi",   "",      'F');
if(datareader) datareader->AddSpectator("lep2_phi",    &vbsEvent.lep2_phi        );
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("lep2_trigEffWeight",    "lep2_trigEffWeight",   "",      'F');
if(datareader) datareader->AddSpectator("lep2_trigEffWeight",    &vbsEvent.lep2_trigEffWeight        );
 
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("lumin",    "lumin",   "",      'F');
if(datareader) datareader->AddSpectator("lumin",    &vbsEvent.lumin        );
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("vbf1_AK4_m",    "vbf1_AK4_m",   "",      'F');
if(datareader) datareader->AddSpectator("vbf1_AK4_m",    &vbsEvent.vbf1_AK4_m        );
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("vbf1_AK4_pt",    "vbf1_AK4_pt",   "",      'F');
if(datareader) datareader->AddSpectator("vbf1_AK4_pt",    &vbsEvent.vbf1_AK4_pt        );
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("vbf2_AK4_m",    "vbf2_AK4_m",   "",      'F');
if(datareader) datareader->AddSpectator("vbf2_AK4_m",    &vbsEvent.vbf2_AK4_m        );
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("vbf2_AK4_pt",    "vbf2_AK4_pt",   "",      'F');
if(datareader) datareader->AddSpectator("vbf2_AK4_pt",    &vbsEvent.vbf2_AK4_pt        );
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("vbf_eta",    "vbf_eta",   "",      'F');
if(datareader) datareader->AddSpectator("vbf_eta",    &vbsEvent.vbf_eta        );
...
//TMVA spectator 
if(dataloader) dataloader->AddSpectator("year",    "year",   "",      'I');
if(datareader) datareader->AddSpectator("year",    &vbsEvent.year        );
