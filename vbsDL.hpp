...
#define vbsDL_hpp
//
//Note::Autogenerated with writeDL.sh on Tue 03 May 2022 09:12:55 PM EDT
//Please check vbsDL*.hpp for available configurations.
//TMVA vars:
//bos_PuppiAK8_eta bos_PuppiAK8_tau2tau1 vbf_m lep1_eta nJet30f vbf_deta zeppLep vbf2_AK4_qgid vbf1_AK4_qgid vbf2_AK4_eta vbf1_AK4_eta zeppHad vbf_eta bos_PuppiAK8_m_sd0_corr dibos_m
...
//TMVA variable
if(dataloader) dataloader->AddVariable("dibos_m", "dibos_m", "", 'F');
if(datareader) datareader->AddVariable("dibos_m",    &vbsEvent.dibos_m        );
