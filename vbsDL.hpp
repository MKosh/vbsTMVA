...
#define vbsDL_hpp
//
//Note::Autogenerated with writeDL.sh on Sun Jan 30 09:17:15 AM EST 2022
//Please check vbsDL*.hpp for available configurations.
//TMVA vars:
//lep1_pt bos_PuppiAK8_pt bos_PuppiAK8_phi bos_PuppiAK8_eta bos_PuppiAK8_tau2tau1 vbf_m lep1_eta nJet30f vbf_deta vbf1_AK4_pt zeppLep vbf2_AK4_qgid vbf1_AK4_qgid vbf2_AK4_eta vbf1_AK4_eta vbf2_AK4_pt zeppHad vbf_eta bos_PuppiAK8_m_sd0_corr
...
//TMVA variable
if(dataloader) dataloader->AddVariable("bos_PuppiAK8_phi", "bos_PuppiAK8_phi", "", 'F');
if(datareader) datareader->AddVariable("bos_PuppiAK8_phi",    &vbsEvent.bos_PuppiAK8_phi        );
