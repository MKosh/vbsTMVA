...
{
   fFisher0 = -0.128343581029;
   fFisherCoefficients.push_back( -0.000219754313919 );
   fFisherCoefficients.push_back( 0.000792893005255 );
   fFisherCoefficients.push_back( -0.000105961264236 );
   fFisherCoefficients.push_back( -0.000974286392292 );
   fFisherCoefficients.push_back( 9.46712950544e-05 );
   fFisherCoefficients.push_back( 8.04358622647e-05 );
   fFisherCoefficients.push_back( 0.000121588388816 );
   fFisherCoefficients.push_back( -0.000325846980119 );
   fFisherCoefficients.push_back( -0.000525783752471 );
   fFisherCoefficients.push_back( 9.35078425968e-06 );
   fFisherCoefficients.push_back( -0.000166526132581 );
   fFisherCoefficients.push_back( 2.18132427052e-05 );
   fFisherCoefficients.push_back( -0.000145758692517 );
   fFisherCoefficients.push_back( -0.0436341767157 );
   fFisherCoefficients.push_back( 9.71831810319e-05 );
   fFisherCoefficients.push_back( -1.99003475595e-05 );
   fFisherCoefficients.push_back( -0.000102680166829 );
