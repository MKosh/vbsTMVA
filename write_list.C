{
    ...
    std::vector<std::string> ntuples = {
		...
		"ST_s-channel_antitop_4f_InclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8.root",
    ...
    string location="/mnt/e/Research/ntuples/NEW/haddedFiles/"; // on my personal desktop
