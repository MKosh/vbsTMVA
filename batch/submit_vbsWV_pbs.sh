...
echo "Running job"
source dsw.sh
root -b -q ./vbsTMVAClassification.C\(\"vbs_ww\",\"BDT,MLPBFGS,DNN_GPU\"\) 
root -b -q ./vbsTMVAClassificationApplication.C\(\"vbs_ww\",\"BDT,MLPBFGS,DNN_GPU\"\)
#
###
echo "Job finished"
cd $BATCH_DIR
